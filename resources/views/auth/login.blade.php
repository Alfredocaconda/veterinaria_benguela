                                                ...
                                                @if ($errors->has('email'))
                                                   <div class="alert alert-danger" id="alert-login">
                                                      ...
                                                      @if(session('wait_seconds'))
                                                            <br>Aguarde <span id="contador">{{ session('wait_seconds') }}</span>s antes de tentar novamente.
                                                      @endif
                                                   </div>
                                                @endif
                                            </div>
    ...
    <script>
      ...
      <script>
         document.addEventListener("DOMContentLoaded", function() {
            ...
            if (contador && alerta) {
               let tempo = parseInt(contador.textContent);
               ...
               let intervalo = setInterval(() => {
                     ...
                     if (tempo <= 0) {
                        ...
                        alerta.innerHTML = "<strong>Pode tentar novamente agora.</strong>";
                     }
               }, 1000);
            }
         });
