        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title" style="display: flex; justify-content: space-between; width: 100%">
                    <h4 class="card-title">Cadastra Animal</h4>
                ...
                <div class="table-responsive">
                    ...
                    <thead>
                        <tr class="ligth">
                            ...
                            <th>Genero</th>
                            <th>Idade</th>
                            <th>Especie / Raça / Pelagem / Ondulada</th>
                            <th>Cor</th>
                            <th>Cauda</th>
                            <th>Responsavel</th>
                            <th>Opões</th>
                    ...
                    <tbody>
                        @foreach ($valor as $func)
                            <tr>
                                ...
                                <td>{{$func->especie." / ".$func->raca." / ".$func->pelagem_comprida." / ".$func->ondulada}}</td>
                                <td>{{$func->cor}}</td>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <form action="{{ route('animal.store') }}" method="post">
                        ...
                        <div class="row">
                            <x-input-normal id="nome" name="nome" type="text" titulo="Nome do Animal" alert="" />
                            ...
                            <div class="form-group col-12 col-md-6 col-lg-6">
                                <label for="idade">Idade do animal <span style="color: red;">*</span></label>
                                <div class="form-input">
                                    <input type="text" 
                                           class="form-control" 
                                           name="idade" 
...
<script>
    ...
    function editar(valor) {
        if (!valor) {
            console.error("Erro: Dados do Animal não encontrados.");
            return;
        }
        ...
        let form = document.getElementById('formAnimal');
        if (valor.id) {
            form.action = `/animal/${valor.id}`;  // Ajuste conforme sua rota de atualização
            form.method = "POST"; // Laravel aceita PUT/PATCH com _method
            form.innerHTML += '<input type="hidden" name="_method" value="PUT">';
        } else {
            form.action = "{{ route('animal.store') }}"; // Criar novo
        }
    }
